...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->SideBarWrapper->Size = System::Drawing::Size(169, 415);
			...
			this->bunifuSeparator1->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			...
			this->lineSidebar->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			...
			this->btnSale->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			...
			// Wrapper
			// 
			this->Wrapper->Location = System::Drawing::Point(169, 66);
